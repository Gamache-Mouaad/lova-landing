...
export const GamesSection = () => {
  return (
    <section dir="rtl" className=" bg-amber-200 w-full  py-5 px-5 md:px-5 relative overflow-hidden">
      <div className=" bg-yellow-700  w-full flex flex-col justify-between gap-10  p-10 ">
        {/* Header Section - Left aligned */}
        <div className=" bg-amber-300 flex flex-col items-start  text-right">
          ...
          <p className="text-2xl md:text-2xl text-[#6B6B78] font-medium max-w-2xl leading-relaxed">
...
اختر لعبتك المفضلة واستمتع بأوقات تعليمية مليئة بالمرح والإثارة.
        ...
        {/* Games Grid */}
        <div className=" bg-amber-600 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
          {games.map((game, index) => (
            ...
            >
              {/* Floating Game Image */}
              <div  className="absolute bg-blue-800 -top-6 -left-[-140px] z-20 w-44 md:w-52 transition-transform duration-500 group-hover:scale-105 group-hover:-translate-y-2">
                <img
                  src={game.image}
                  alt={game.title}
