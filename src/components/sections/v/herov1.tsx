...
import { Play } from 'lucide-react'; // <-- imported play icon
...
import star from '../../assets/items/stars.png'
...
const HeroSection = () => {
  return (
    <section className="relative min-h-[900px] overflow-hidden bg-white pt-32 pb-20">
      <div className="container mx-auto px-4 text-center">
        <div className="relative max-w-6xl mx-auto">

          {/* Decorative Items */}
          <div className="relative">
            <img src={item3} alt="" className="absolute -top-16 left-[10%] w-20 md:w-28 z-10" />
            <img src={item4} alt="" className="absolute -top-14 right-[12%] w-16 md:w-20 z-10" />
            <img src={item1} alt="" className="absolute top-10 left-[2%] w-16 md:w-24" />
            <img src={item5} alt="" className="absolute top-20 right-[3%] w-16 md:w-24" />
          </div>

          {/* Side kid images */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 w-48 md:w-72 hidden lg:block">
            <div className="relative">
          ...
          <div className="absolute right-0 top-1/2 -translate-y-1/2 w-48 md:w-72 hidden lg:block">
            <div className="relative">
          ...
          <div className="relative z-20">
            <h1 className="flex flex-wrap items-center justify-center gap-4 text-7xl md:text-[120px] font-black text-[#1a1a1a] tracking-tighter leading-none">
              <span>عالم</span>
              <img src={lovaSmile} alt="Lova" className="h-24 md:h-36 sm:h-9 w-auto inline-block" />
              <span>ألعاب</span>
            </h1>
            <h2 className="mt-2 text-7xl md:text-[120px] font-black text-[#1a1a1a] tracking-tight flex items-center justify-center gap-4">
              وحكايات <span className="text-[#8B7BFF]">سمعية</span>
            </h2>
            ...
            <div className="mt-6 space-y-1 font-medium">
              ...
              <p className="text-lg md:text-xl text-[#8B7BFF] mt-2">
                لأعمار ٦-١٣ سنة. ضحوك صديق صغارك في القصص والألعاب
              </p>
            </div>

            {/* Buttons – using Play icon from lucide-react */}
            ...
            {/* Trust Badge */}
            <div className="w-full flex items-center justify-center py-4 px-6  mt-6">
              <p className="text-sm md:text-base font-bold text-[#6B6B78]">
                انضم إلى أكثر من <span className="text-[#8B7BFF]">٥٠٠٠</span> أسرة عربية
              </p>
